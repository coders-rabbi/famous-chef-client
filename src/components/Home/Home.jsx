    ...
    return (
        <div className='container mx-auto border border-logo-color px-4'>
            <div className='relative'>
                ...
                <div className='absolute text-white md:top-1/2 md:left-1/3 md:-translate-x-1/2 -translate-y-1/2 '>
            ...
            <div className='mt-36'>
                ...
                <div className='mt-10 grid lg:grid-cols-2 2xl:grid-cols-3  gap-5'>
                    {
                        chef.map(data => <Chef
                            key={data.id}
                            chef={data}

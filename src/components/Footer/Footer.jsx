...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content md:flex justify-around">
                <div className='mx-auto md:mx-0'>
                    <span className="footer-title">Services</span>
                    <a className="link link-hover">Chef </a>
                    <a className="link link-hover">Food</a>
                    <a className="link link-hover">party center</a>
                ...
                <div className='mx-auto md:mx-0'>
                    <span className="footer-title mx-auto md:mx-0">Subcribe</span>
                    <div className="form-control w-80">
                        <label className="label">
                            <span className="label-tex mx-auto md:mx-0">Enter your email address</span>
                        </label>
                        <div className="relative text-center">
                            <input type="text" placeholder="username@site.com" className="input input-bordered w-full pr-16" />
                            <button className="btn btn-primary mt-3 md:mt-0 md:absolute top-0 right-0 md:rounded-l-none">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
            <div className="footer items-center p-4 bg-neutral text-neutral-content flex justify-around">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - All right reserved by Rabbi Mia</p>
                </div>
